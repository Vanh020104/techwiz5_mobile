...
class _PendingPageState extends State<PendingPage> {
  ...
  Future<void> fetchOrders() async {
    final url = Uri.parse('https://techwiz5-order-service-dchugggwh5g9hjdx.eastasia-01.azurewebsites.net/api/v1/orders/user/$userId/status?status=PENDING');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Pending Orders', style: TextStyle(fontSize: 18, color: Colors.white)),
